...
-- Super Admin seed (login: admin@vidyasetu.local / ChangeMe123!)
INSERT INTO "users" ("id", "email", "password_hash", "first_name", "last_name", "global_role", "is_active", "email_verified_at", "created_at", "updated_at")
VALUES (
  'clvsuperadmin000000000001',
  'admin@vidyasetu.local',
  '$2b$12$iFDBVmkPq9Qqm9T.yIoh3ukOobOWH8osIUmMd79S2BW5qEsqffTFC',
  'Super',
  'Admin',
  'SUPER_ADMIN',
  true,
